...
#     lm = nltk.probability.ConditionalProbDist(cfd, nltk.probability.LidstoneProbDist, 0.2)
    lm = nltk.probability.ConditionalProbDist(cfd, nltk.probability.WittenBellProbDist, 10000)
    return(lm)
...
def get_args():
    ...
    parser.add_argument('-lmbd','--lambda_value', type=float, nargs=3, default=[0.69,0.01,0.3],
