...
def get_args():
    ...
    parser.add_argument('-t','--translation', nargs='*',default=['translations/translations'],
...
#     translations = tf.readlines()        
    ...
    name_pattern = "^translation.(\d+)((?:.h)?(?:.s)?)$"
    scores = {}
...
#     scores_dict={}
#     pyplot.figure(1)
#     scores_dict = collections.OrderedDict(sorted(scores[''].items()))
#     pyplot.title('')
#     pyplot.xlabel('lambda_phi')
#     pyplot.ylabel('bleu score')
#     pyplot.plot(scores_dict.keys(),scores_dict.values(),'b',label='1000')
#     pyplot.figure(2)
#     scores_dict = collections.OrderedDict(sorted(scores['.h'].items()))
#     pyplot.title('with heuristic function')
#     pyplot.xlabel('lambda_phi')
#     pyplot.ylabel('bleu score')
#     pyplot.plot(scores_dict.keys(),scores_dict.values(),'b',label='1000')
#     pyplot.figure(3)
#     scores_dict = collections.OrderedDict(sorted(scores['.h.s'].items()))
#     pyplot.title('with heuristic function and and smaller n-gram language model')
#     pyplot.xlabel('lambda_phi')
#     pyplot.ylabel('bleu score')
#     pyplot.plot(scores_dict.keys(),scores_dict.values(),'b',label='1000')
#     pyplot.figure(4)
#     scores_dict = collections.OrderedDict(sorted(scores['.s'].items()))
